...
public interface BookingService {
    ...
    List<BookingDto> findAllBookingsByOwnerIdAndState(Long ownerId, String state);

    List<BookingDto> findAllBookingsForOwnerItemsWithState(Long ownerId, String state);
