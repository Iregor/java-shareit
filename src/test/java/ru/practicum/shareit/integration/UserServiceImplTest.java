...
public class UserServiceImplTest {
    ...
    public void createUser_validUser_succeed() {
        user = UserMapper.toUser(userService.createUser(new User(null, "name", "email@mail.ru")));
    ...
    public void findAllUsers_2users_succeed() {
        ...
        assertThat(userService.findAllUsers())
                .hasSize(2)
                .element(0)
                .isEqualTo(UserMapper.toDto(user1));
        assertThat(userService.findAllUsers())
                .element(1)
                .isEqualTo(UserMapper.toDto(user2));
    }
    ...
    public void patchUser_succeed() throws IllegalAccessException {
        user = UserMapper.toUser(userService.createUser(new User(null, "name1", "email1@mail.ru")));
