...
public class ItemControllerTest {
    ...
    @Test
    public void createItem_blankName_exceptionThrown() throws Exception {
        String blankName = "   ";
    ...
    @Test
    public void createItem_blankDescription_exceptionThrown() throws Exception {
    ...
    @Test
    public void createItem_nullAvailable_exceptionThrown() throws Exception {
    ...
    @Test
    public void createComment_blankText_exceptionThrown() throws Exception {
        String blankText = "   ";
        commentDto.setText(blankText);
        long itemId = 1L;
        long commentatorId = 1L;
        LocalDateTime created = LocalDateTime.of(2023, 6, 7, 0, 0);
